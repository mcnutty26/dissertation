...
if ($_POST['action'] == 'content') {
    ...
    if (isset($_POST['module'])) {
        ...
        echo '<table><thead><tr><td>Question ID</td><td>Name</td><td>Question</td><td>Tags</td><td>Edit?</td></tr></thead>';
        while($row = mysqli_fetch_array($result)) {
            echo '<tr><td>' . $row['contentid'] . '</td><td>' . $row['name'] . '</td><td>' . $row['question'] . '</td><td>' . $row['tag'] . '</td><td><form action="create.php" method="post"><input type="hidden" name="action" value="answer"><input type="hidden" name="content" value="' . $row['contentid'] . '"><input type="submit" value="Edit"></form></td></tr>';
        }
