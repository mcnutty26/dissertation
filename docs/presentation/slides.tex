...
\begin{document}
	...
	\vspace{0.5cm}
	Which bring us nicely round to the original question:
	\begin{itemize}
	...
	\frametitle{Research Analysis}
		...
		In order to fully explain these findings we have to go back and re-examine the theory of games themselves. The Frenchman Roger Callois described in his work ``Man, Play and Games'' a type of play he called \textit{mimicry}:
		\begin{quotation}
