...
\begin{document}
	...
	\frametitle{Project Overview}
		Is there a link between how we learn and how we play?
		\newline
			
The project set out to determine the place of the gamer types put forward by Richard Bartle in gamified higher education. In addition to a literature review, a study into the relationship between students' personality and the way in which they behave when playing games was conducted. 
	}
	...
	\frame{
		...
		\begin{quotation}
			``The use of game design elements \\ in non-game contexts''\footnote{Deterding et al. From game	design elements to gamefulness: defining gamification. In Proceedings of the 15th International Academic MindTrek Conference, 2011.}
		\end{quotation}
	...
	\frame{
		...
		Uses a combination of gamification and data analysis to enrich all aspects of campus life - from learning to sport and healthy eating.
		\newline
	...
	Proposed by Richard Bartle in his 1996 paper, the model categorises players into Socialisers, Killers, Achievers and Explorers\footnote{Richard Bartle. Virtual worlds: Why people play. Massively Multiplayer Game
		Development 2, 2005.}. It acts as a way of psychologically profiling gamers based on their thoughts and actions in-game.
	...
	\frame{
	\frametitle{Bartle's Gamer Types}	
		Bartle types can be used to reason about ecosystems of players in online multiplayer games. For example, the effect on the player base of increasing one type of user can be seen below.\footnote{Richard Bartle. Virtual worlds: Why people play. Massively Multiplayer Game Development 2, 2005.}
		\newline
	...
	\frametitle{Research Analysis}
		...
		setting; it's the characters that make it so compelling''\footnote{Richard Bartle. Virtual worlds: Why people play. Massively Multiplayer Game Development 2, 2005.}
		\end{quotation}
	}
	...
	\frametitle{Research Analysis}
		...
		\begin{quotation}
			...
			or temporarily sheds his personality in order to gain another}''\footnote{Roger Caillois, translated by Meyer Barash. Man, Play, and Games. Freedom Press, 1961.}
		\end{quotation}
	}
	...
	\begin{itemize}
		...
		\item Direct efforts towards the relationship between learning style and task preference (Schaller et al.\footnote{Schaller et al. One size does not fit all: Learning style, play, and on-line interactives. http://www.eduweb.com/OneSizeDoesNotFitAll.pdf, 2007.})
	\end{itemize}
