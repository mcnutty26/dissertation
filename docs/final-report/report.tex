...
In this chapter the testing methodology is presented, along with detailed description and justification of the research methods and statistical analysis used. The aim of the work carried out as part of this project is to identify any potential correlation between Bartle gamer types and Keirsey temperaments with the aim of better understanding the human computer interaction that will arise as gamification becomes more prevalent in higher education. As the target demographic for higher education software, [twenty] students from the University of Warwick participated in the study. Afterwards the results of the study are detailed and discussed in the context of prior work by Konert et. al \cite{konertmodeling} and the implications for designing future educational software are conjectured.
\section{Methodology}
Participants were each given a login code for the online testing software, described below, and asked to fill out a series of profiling questionnaires. Questions for both the Bartle and Keirsey type sorters are attached in appendices \ref{sec:bartle} and \ref{sec:keirsey} respectively. The Bartle questions were sourced from the website of Erwin Andreasen [REF], and are the same ones used in the most popular online Bartle test which can be found at gamerDna [REF]. There does not exist an official set of Bartle test questions. The questions to used to categorise participants by Keirsey Temperament are from the Keirsey Temperament Sorter II \cite{keirsey1998please}. 
...
\chapter{Keirsey Termerament Questions}
\label{sec:keirsey}
\end{appendices}
