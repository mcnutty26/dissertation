...
Due to the interdisciplinary nature of the project, 

\section{What are the ethical issues surrounding gamification?}
While the concept itself has been the focus of much academic work, the ethics surrounding gamification have received little attention. It was remarked on in chapter \ref{sec:background} that gamification has its roots in operant conditioning, a psychological tool that Chiel Versteeg claims \cite{versteeg2013ethics} can be thought of as manipulative in the context of many gamified activities. In designing experiences which use such methods to influence players into accepting whatever the target behaviour of the system is, almost universally without the users knowledge, Versteeg argues that content creators have a moral obligation to consider the impact of their works. The ``manipulation matrix'' shown in figure \ref{matrix} is a good starting point for fathoming the moral implications of a given gamified application, and most educational works fall into the facilitator category.
